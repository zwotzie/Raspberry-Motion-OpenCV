...
# ToDo: iterate over subfolders
sub="mouse"
TRAINING_IMAGES_DIR = os.getcwd() + "/training_images/" + sub
TEST_IMAGES_DIR = os.getcwd() + "/test_images/" + sub
...
TRAIN_CSV_FILE_LOC = TRAINING_DATA_DIR + "/" + sub + "_train_labels.csv"
EVAL_CSV_FILE_LOC = TRAINING_DATA_DIR + "/" + sub + "_eval_labels.csv"
